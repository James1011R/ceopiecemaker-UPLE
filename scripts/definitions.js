...
MOVES = [{
   ...
   "cat": "legacy",
   "name": "valuelessvoid",
   "text": "[Pay 2]: (Ranged) Convert target enemy default moveset into basic move/teleport abilities and negate their augments.",
   "color": [0,0,0],
   "color2": [255,255,255],
   "color3": [153,153,153],
   "symbol1": "\uea81",
   ...
   "hide": true
    ...
    "text": "(Magic) Disenchant enemy unit, allowing them to be attacked by move/teleport abilities for 3 turns.",
    "color": [0,0,255],
    "color2": [0,0,127],
    "symbol1": "\uffec",
    "hide": true
    ...
    "cat": "pretend",
    "name": "specialtykill",
    "text": "(Magic) Negate enemy's moveset except for melee moves and melee attacks.",
    "color": [0,0,0],
    "color2": [255,255,255],
    "symbol1": "\uea26",
    "hide": true
   ...
   "cat": "limbo",
   "name": "jumpswapstart",
   "long": "b]mu:startpos?move/attack/swap",
   ...
   "cat": "limbo",
   "name": "omniswapstart",
   "long": "b]mu:startpos?move/*ally?swap",
   ...
   "cat": "limbo",
   "name": "attackstart",
   "long": "b]mn:startpos?attack",
   "text": "Attack from starting position.",
   "color": [255,0,0],
   "color2": [255,161,161],
   "symbol1": "\u274b",
   "hide": true
   ...
   "cat": "limbo",
   "name": "jumponce",
   "text": "[1 uses] (Unblockable) Move or Attack.",
   "color": [20,151,24],
   "color3": [255,255,255],
   "symbol1": "\uf23d",
   "hide": true
   ...
   "cat": "limbo",
   "name": "teleportonce",
   "text": "[1 uses] (Unblockable) Teleport.",
   "color": [121,19,153],
   "color3": [255,255,255],
   "symbol1": "\uf23d",
   "hide": true
   ...
   "cat": "limbo",
   "name": "jumptwice",
   "text": "[2 uses] (Unblockable) Move or Attack.",
   "color": [20,151,24],
   "color3": [255,255,255],
   "color4": [137,203,139],
   "symbol1": "\uf23d",
   ...
   "cat": "limbo",
   "name": "teleporttwice",
   "text": "[2 uses] (Unblockable) Teleport.",
   "color": [121,19,153],
   "color3": [255,255,255],
   "color4": [188,137,204],
   "symbol1": "\uf23d",
   ...
   "cat": "limbo",
   "name": "jumplose",
   "text": "[Val-2]: (Unblockable) Move or Attack.",
   "color": [20,151,24],
   "color3": [0,0,0],
   "symbol1": "\u{1f505}",
   "hide": true
   ...
   "cat": "limbo",
   "name": "jumpswaplose",
   "text": "[Val-2]: (Unblockable) Move, Attack, or swap places with ally.",
   "color": [255,210,0],
   "color3": [0,0,0],
   "symbol1": "\u{1f505}",
   "hide": true
   ...
   "hide": true
    ...
    "cat": "pretend",
    "name": "deletefarmoves",
    "text": "(Magic) Negate enemy's moveset beyond Range 2.",
    "color": [40,40,40],
    "color3": [0,0,0],
    "symbol1": "\uf806",
    "hide": true
    ...
    "text": "(Magic) Negate enemy's moveset beyond 1 step sideways.",
    "color": [80,80,80],
    "color4": [0,0,0],
    "symbol1": "\u2194",
    "symbol2": "\u{ff0fe}",
    ...
    "cat": "pretend",
    "name": "mine",
    "text": "[Val-5]: (Magic) The next unit to land on marked location is destroyed.",
    "color": [127,127,127],
    "color2": [255,255,255],
    "color3": [0,0,0],
    "color4": [255,0,0],
    ...
    "cat": "pretend",
    "name": "teleportslam",
    "text": "[Pay 4]: (Unblockable) Teleport, then petrify and enchant all adjacent enemies for 1 turn.",
    "color": [121,19,153],
    "color3": [94,200,200],
    "symbol1": "\uf7e3",
    "hide": true
   ...
   "cat": "pretend",
   "name": "deleteall",
   "text": "[Val-4]: (Ranged) Negate enemy unit's value, moveset, and passives.",
   "color": [0,0,0],
   "color2": [255,255,255],
   "color3": [255,0,0],
   "symbol1": "\uea81",
   ...
   "hide": true
    ...
    "text": "[Pay 10]: (Magic) After 10 turns, destroy any unit in marked location, then summon FrostMephit in marked location.",
    "color": [0,0,0],
    "color2": [255,255,255],
    "color3": [0,255,255],
    "symbol1": "\uea3c",
    ...
    "cat": "pretend",
    "name": "passingswap",
    "text": "[1 uses] Swap places with unit, then move 1 space forward.",
    "color": [107,200,200],
    "color3": [0,0,0],
    "color4": [255,255,255],
    "symbol1": "\uec01",
   ...
   "cat": "pretend",
   "name": "deletemoveonly",
   "text": "(Magic) Negate enemy's Move Only and Teleport abilites.",
   "color": [0,0,0],
   "color2": [255,255,255],
   "color3": [0,0,255],
   "color4": [255,0,0],
   ...
   "text": "(Magic) Negate enemy's moveset not on the main eight directions.",
   "color": [0,0,0],
   "color2": [255,255,255],
   "color3": [0,0,0],
   "color4": [0,0,0],
   ...
   "hide": true
    ...
    "cat": "pretend",
    "name": "rewind",
    "text": "(Magic) Teleport unit back to starting position, and destroy any unit on that position.",
    "color": [0,0,0],
    "color2": [0,127,127],
    "color3": [0,255,255],
    "color4": [0,255,255],
    ...
    "cat": "pretend",
    "name": "rewindally",
    "text": "(Magic) Teleport ally back to starting position, and destroy any unit on that position.",
    "color": [0,0,0],
    "color2": [0,127,0],
    "color3": [0,255,0],
    "color4": [0,255,0],
    ...
    "text": "(Passive) Enemy units are exhausted twice as fast in this location.",
    "color": [0,0,0],
    "color2": [255,255,255],
    "symbol1": "\u{1cc43}",
    "hide": true
    ...
    "text": "(Passive) Enemy units are exhausted immediately in this location.",
    "color": [0,0,0],
    "color2": [255,255,255],
    "color3": [255,0,0],
    "symbol1": "\u{1cc43}",
   ...
   "text": "Sorcerize enemy unit, making them lose any immunity for 2 turns.",
   "color": [0,178,255],
   "color2": [0,64,127],
   "color3": [0,255,255],
   "symbol1": "\uffec",
   ...
   "hide": true
    ...
    "text": "Move only, then cause a Temporal Surge if one hasn't happened that turn.",
    "color": [0,0,255],
    "color3": [255,255,255],
    "symbol1": "\u22a1",
    "hide": true
    ...
    "text": "Move or Attack, then cause a Temporal Surge if one hasn't happened that turn.",
    "color": [0,0,0],
    "color3": [255,255,255],
    "symbol1": "\u22a1",
    "hide": true
